...
fn bench_vendor_registry_loading() {
    ...
    for i in 0..5 {
        ...
        let registry =
            nthpartyfinder::vendor_registry::VendorRegistry::load_from_directory(config_dir)
...
fn bench_dns_extraction_throughput() {
    ...
    for _ in 0..iterations {
        let _ = nthpartyfinder::dns::extract_vendor_domains_with_source_and_logger(
            &records, None, "test.com",
        );
    }
    let elapsed = start.elapsed();
